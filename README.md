...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gz-msgs-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gz-msgs-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
Once the `conda-forge` channel has been enabled, `gz-msgs, gz-msgs-python, gz-msgs10, gz-msgs10-python, libgz-msgs, libgz-msgs10` can be installed with `conda`:

```
conda install gz-msgs gz-msgs-python gz-msgs10 gz-msgs10-python libgz-msgs libgz-msgs10
```

or with `mamba`:

```
mamba install gz-msgs gz-msgs-python gz-msgs10 gz-msgs10-python libgz-msgs libgz-msgs10
```
